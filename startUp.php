...
$sql_insert = "
    ...
    ('Bowling Hills', 'Coors', 'United States', 'IPA', 'Double IPA', 20, 'A bold and bitter IPA with tropical fruit flavors.', 'Pairs well with grilled meats and spicy foods.', 12.0, 355, 7.5, 70, 12, 200, 'test.jpeg', 0, 15, '2024-12-05', '2024-12-10', 1),
    ('Finnish Dream', 'Coors', 'Germany', 'IPA', 'Double IPA', 20, 'A bold and bitter IPA with tropical fruit flavors.', 'Pairs well with grilled meats and spicy foods.', 12.0, 355, 7.5, 70, 12, 200, 'test.jpeg', 0, 15, '2024-12-05', '2024-12-10', 1),
    ('Crimson Tide', 'Founders Brewing', 'Belgium', 'Pale Ale', 'Session Pale Ale', 20, 'A smooth and refreshing pale ale with citrus notes.', 'Pairs well with seafood and salads.', 4.2, 330, 5.0, 35, 8, 150, 'crimson_tide.jpeg', 1, 15, '2024-12-06', '2024-12-10', 1),
    ('Golden Peaks', 'Sierra Nevada', 'Germany', 'Lager', 'Helles Lager', 15, 'A crisp and malty lager with a light golden color.', 'Pairs well with light appetizers and pretzels.', 5.0, 500, 5.3, 18, 4, 120, 'golden_peaks.jpeg', 1, 15, '2024-12-07', '2024-12-10', 1),
    ('Bitter End', 'Coors', 'Belgium', 'India Pale Ale', 'ESB', 20, 'A traditional English ale with a balanced bitter taste.', 'Pairs well with grilled meats and hearty stews.', 5.8, 375, 6.0, 40, 10, 140, 'bitter_end.jpeg', 1, 15, '2024-12-06', '2024-12-10', 1),
    ('Stormbringer', 'Firestone Brewing', 'Canada', 'Pale Ale', 'West Coast IPA', 25, 'A bold IPA with pine and citrus aromas.', 'Pairs well with spicy foods and barbecue.', 6.5, 400, 7.2, 65, 12, 180, 'stormbringer.jpeg', 1, 15, '2024-12-07', '2024-12-10', 1),
    ('Mountain Roar', 'Everest Brewing', 'India', 'IPA', 'Double IPA', 30, 'A massive double IPA with tropical fruit and pine flavors.', 'Pairs well with spicy Indian curries and rich meats.', 8.0, 355, 9.0, 80, 14, 190, 'mountain_roar.jpeg', 1, 15, '2024-12-06', '2024-12-10', 1),
    ('Velvet Storm', 'Stormbreaker Brewing', 'Australia', 'Stout', 'Imperial Stout', 25, 'A rich and velvety stout with dark chocolate and coffee notes.', 'Pairs well with desserts like brownies and dark chocolate.', 10.5, 330, 8.5, 50, 18, 160, 'velvet_storm.jpeg', 1, 15, '2024-12-07', '2024-12-10', 1),
    ('Whispering Pines', 'Forest Grove Brewery', 'Finland', 'Pale Ale', 'American Pale Ale', 18, 'A balanced pale ale with floral hops and a malty backbone.', 'Pairs well with grilled fish and vegetables.', 5.2, 400, 5.5, 40, 8, 130, 'whispering_pines.jpeg', 1, 15, '2024-12-05', '2024-12-10', 1),
    ('Twilight Brew', 'Shadow Mountain Brewing', 'Belgium', 'Belgian Ale', 'Tripel', 25, 'A smooth and fruity Belgian Tripel with hints of spice.', 'Pairs well with rich cheeses and charcuterie.', 9.0, 330, 9.5, 35, 14, 170, 'twilight_brew.jpeg', 1, 15, '2024-12-06', '2024-12-10', 1),
    ('Red Fury', 'Wildfire Brewing', 'USA', 'Red Ale', 'American Red Ale', 15, 'A malt-forward red ale with caramel and toffee flavors.', 'Pairs well with burgers and roasted meats.', 6.2, 500, 6.0, 40, 10, 140, 'red_fury.jpeg', 1, 15, '2024-12-07', '2024-12-10', 1),
    ('Tropical Blaze', 'Sunshine Brewing', 'Mexico', 'Pale Ale', 'New England IPA', 30, 'A juicy IPA with tropical fruit notes and a hazy appearance.', 'Pairs well with seafood tacos and spicy salsas.', 7.2, 355, 8.0, 45, 12, 175, 'tropical_blaze.jpeg', 1, 15, '2024-12-05', '2024-12-10', 1);
